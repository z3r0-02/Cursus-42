...
<h3>Sources I've used to finish this project:</h3>
  ...
  - <a href="https://github.com/pasqualerossi/Born2BeRoot-Guide" target="_blank" rel="noreferrer noopener">pasqualerossi guide</a> | Does not contain the bonus, but has pictures to guide you to set up the VM for the mandatory part
